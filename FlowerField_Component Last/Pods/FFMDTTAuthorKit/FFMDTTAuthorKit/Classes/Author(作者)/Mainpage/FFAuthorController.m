...
//    AFURLSessionManager *urlSession = [[AFURLSessionManager alloc] init];
//    [urlSession.session dataTaskWithURL: [NSURL URLWithString:@"https://www.baidu.com"]];
    //    UIViewController *controller = [[FFSpecialDetailController alloc] init];
    UIViewController *controller = [[MDMediator sharedInstance] specialDetailController];
    [self.navigationController pushViewController:controller animated:YES];
}
