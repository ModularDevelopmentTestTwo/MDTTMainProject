...
- (void)handleData {
    ...
    [RACObserve(self, dataDict) subscribeNext:^(NSDictionary *data) {
        ...
        NSDictionary *author = [[MDMediator sharedInstance] authorReformerWithOriginData: data[kAuthorReformer]];
        
        [self.pictureView yy_setImageWithURL:data[kSpecialPropertyListKeyPictureURL] placeholder:[UIImage imageWithBundle:[self class] imgName:@"placehodler"]];
        [self.headImgView yy_setImageWithURL:author[kAuthorPropertyListHeaderURL] placeholder:[UIImage imageWithBundle:[self class] imgName:@"pc_default_avatar"]];
...
//        _headImgView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"pc_default_avatar"]];
        _headImgView = [[UIImageView alloc]initWithImage:[UIImage imageWithBundle:[self class] imgName:@"pc_default_avatar"]];
...
- (UIImageView *)authImgView{
    if (_authImgView == nil) {
        _authImgView = [[UIImageView alloc]initWithImage:[UIImage imageWithBundle:[self class] imgName:@"personAuth"]];
    }
    return _authImgView;
}
...
- (UIImageView *)underlineImgView{
    if (_underlineImgView == nil) {
        ...
        _underlineImgView.backgroundColor = [UIColor lightGrayColor];
    }
